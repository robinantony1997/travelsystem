...
$carID=$id=$mName=$bid=$variant=$variantName='';
$img='Choose Image';
...
if(isset($_POST['submit'])) { 
    ...
    if($carID != ''){ 
        if(isset($_FILES['image']) && !empty($_FILES['image']['name'])){
            ...
            //header("Location:../admin/carPicsView.php");
            echo '<script>window.location="../admin/carPicsView.php"</script>';
        }
        else{ 
       ...
       //header("location:../admin/carPics.php");
       echo '<script>window.location="../admin/carPics.php"</script>';
    }
