...
{
	$id=$_GET["id"];
    mysqli_query($con,"delete from entertainment where entid=$id ");
    //header ("location:exteriorView.php");
    echo '<script>window.location="../admin/dimensionsView.php"</script>';
...
<div class="container jumbotron p-3 my-3 ">
    <div class="card">
        <div class="card-header">
            <h5 class="title">Dimension Details</h5>
        </div>
        <div class="card-body">
